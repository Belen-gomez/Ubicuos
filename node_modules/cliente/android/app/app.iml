...
<module external.linked.project.id=":app" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/.." external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: __local_aars__:C./Users/thels/OneDrive/Documentos/React-Native-Tests/cliente/android/app/libs/payment-1.14.10.181016.aar:unspecified@jar" level="project" />
    ...
    <orderEntry type="library" name="Gradle: com.journeyapps:zxing-android-embedded:3.4.0@aar" level="project" />
    <orderEntry type="library" name="Gradle: me.dm7.barcodescanner:zxing:1.9.8@aar" level="project" />
    <orderEntry type="library" name="Gradle: me.dm7.barcodescanner:core:1.9.8@aar" level="project" />
